...
from inits import initialize_detector
...
if __name__ == '__main__':
    ...
    faces, labels = get_images_and_labels(img_src+'/new/') #(path)
    sampling_end = time.time()
    sampling_time = int((sampling_end - sampling_start)*1000)
    print(f"Samples created successfully in {sampling_time} ms.")
