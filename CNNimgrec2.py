...
from imports.CNNinits_registry import save_registry
...
def get_images_and_labels(path):
    ...
    for image_path in image_paths:
        ...
        #store face samples, store all labels
        face_samples.append(images)
...
if __name__ == '__main__':
    ...
    faces, labels = get_images_and_labels(img_src+'/imagesCNN/')
    ...
    recognizer.save(img_src+'/CNNmodel.yml')
